...
RUN --mount=type=cache,id=s/81415cd9-6519-4566-a6ef-b6e13f161d2b-/root/.local/share/pnpm/store,target=/root/.local/share/pnpm/store pnpm install --frozen-lockfile
COPY --exclude=.git/ . .
RUN make frontend
